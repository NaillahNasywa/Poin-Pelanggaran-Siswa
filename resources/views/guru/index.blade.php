    ...
    <div class="row ">
      <div class="col-12">
        <h4 class="card-title">guru</h4>
            <a href="{{ route('guru.create') }}" class="card-description">
                Add <code>+</code>
              </a>
        <div class="row my-4">
          <!-- Small table -->
              ...
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Phone: activate to sort column ascending" style="width: 42.375px;">nipd</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 77.3125px;">alamat</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 77.3125px;">nohp</th>
                      <th class="sorting" tabindex="0" aria-controls="dataTable-1" rowspan="1" colspan="1" aria-label="Department: activate to sort column ascending" style="width: 77.3125px;">email</th>
                ...
                <tr>
                  ...
                  <div class="dropdown-menu dropdown-menu-right">
                    <a class="dropdown-item mdi mdi mdi-clipboard-text" href="{{ route ('guru.show',$item->id) }}">detail</a>
                    <a class="dropdown-item mdi mdi-pencil" href="{{ route ('guru.edit',$item->id) }}">edit</a>
